/*Programmer Name: Gabriela Liera, Jonathan Ebueng, Karlos Valles
  ...
  Date: 6/7/2022
  Description: The purpose of this file is to populate the sticker_sc database with values. 
  Nine stickers are inserted into the stickers table. Three categories are inserted 
  into the categories table. A username and password are inserted into the admin table.*/

--To run this file enter to command line: mysql -u root -p < htdocs/final/populate.sql
